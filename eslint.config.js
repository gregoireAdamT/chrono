...
export default [
    ...
    rules: {
      ...
      'no-unused-vars': [
        'warn',
        {
          ...
          varsIgnorePattern:
            '^(test|creer|initialiser|diagnostic|switchTab|modifier|supprimer|exporter|vider|lastBackupTime|reject|sheet|spreadsheet|toggleBackupSection|enregistrerDepartAvecFocus|enregistrerArriveeAvecFocus)', // Extended pattern
        },
      ],
  ...
  // Ignore patterns (replaces .eslintignore)
  {
    ignores: [
      ...
      'build/**',
      '*.min.js',
      '*.css', // IMPORTANT: Ignore CSS files
      '*.html', // IMPORTANT: Ignore HTML files
    ],
  },
];
